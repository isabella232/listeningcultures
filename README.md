...
**TKTK: Describe listeningcultures here.**
...
```
cd listeningcultures
mkvirtualenv listeningcultures
...
```
* * * * * ubuntu bash /home/ubuntu/apps/listeningcultures/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|listeningcultures|tweet|`location`||||
|listeningcultures|facebook|`location`||||
|listeningcultures|email|`location`||||
|listeningcultures|new-comment||||
|listeningcultures|open-share-discuss||||
|listeningcultures|close-share-discuss||||
|listeningcultures|summary-copied||||
|listeningcultures|featured-tweet-action|`action`||``tweet_url``|
|listeningcultures|featured-facebook-action|`action`||``post_url``|
